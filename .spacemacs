...
you should place your code here."
  ...
  (add-to-list 'auto-mode-alist '("\\.org\\'" . oorg-archive-locationrg-mode))
...
(custom-set-variables
 ...
 '(org-agenda-files (quote ("~/contentful.org")))
